...
osv = subprocess.Popen('cd ../..; scripts/run.py -c1 -i %s -g -e "--trace=memory* --trace=lockdep* --nomount tools/mkfs.so" --forward tcp:10000::10000' % image_path, shell = True, stdout=subprocess.PIPE)
