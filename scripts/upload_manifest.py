...
def main():
    ...
    osv = subprocess.Popen('cd ../..; scripts/run.py  -c1 -i %s -u -s -e "--trace-backtrace --trace=sth --trace=zil_commit /tools/cpiod.so" --forward tcp:10000::10000' % image_path, shell = True, stdout=subprocess.PIPE)
