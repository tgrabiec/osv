...
def require_running(module_name, run_config='*'):
    """
    @run_config is the name of required run configuration. There are two values with special meaning:

      '*'    represents a relaxed requirement, any run configuration will suffice. If not overriden will yield
